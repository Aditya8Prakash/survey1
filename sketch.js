...
showtime = createElement('h3');
showtime.position(50,50);

showdate = createElement('h3');
showdate.position(50,90);
...
showtime.html("Time : "+ a + " : "+minute+median);
showdate.html("Date : "+day+" / "+month+" / "+year);
...
function okTime(){
database.ref('survey/time').set({'time': a + " : "+minute+median,'day':+day+" / "+month+" / "+year })
}
function okName(){
